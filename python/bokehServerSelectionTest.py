...
class bokehServerSelectionTest():
    ...
    def write_run_plot(self, run=None, site_type=None):
        ...
        return test_list, test_list_rn


pG = bokehServerSelectionTest(db='Prod', server='Prod', base_dir="")

gains, noise = pG.write_run_plot(site_type="BNL-Raft", run=7983)
